...
module.exports = {
  getPayments: async (req, res, next) => {
    ...
    // }
    let sql = `SELECT p.admission_no,paid_amount,payment_mode,payment_cause,
    invoice_no,invoice,p.createdAt,firstName,lastName,email,course,academic_year FROM payments p
